...
# Define o titula da pagina, o icone e o layout para ocupar a largura inteira
...
#O dataframe principal [e filtrado com base nas seleções feitas na barra lateral
df_filtrado = df[
...
col4.metric("Cargo mais frequente", cargos_mais_frequente)

st.markdown("---")

# --- Analises Visuais com Ploty 
